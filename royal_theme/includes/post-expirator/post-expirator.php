...
/* Add post-type specific call _slides, _post, etc. */
add_action ('add_meta_boxes_slides','expirationdate_meta_custom');
add_action ('add_meta_boxes_post','expirationdate_meta_custom');
...
function postexpirator_css() {
  wp_register_style( 'postexpiratorcss', get_template_directory_uri() . '/post-expirator/post-expirator-style.css' );
  wp_enqueue_style('postexpiratorcss');
} 
